...
SV * perl_png_get_cHRM (perl_libpng_t * png)
{
    if (VALID (cHRM)) {
        ...
        ice = newHV ();
        hv_store (ice, "white_x", strlen ("white_x"),
                   newSVnv (white_x), 0);
        hv_store (ice, "white_y", strlen ("white_y"),
                   newSVnv (white_y), 0);
        hv_store (ice, "red_x", strlen ("red_x"),
                   newSVnv (red_x), 0);
        hv_store (ice, "red_y", strlen ("red_y"),
                   newSVnv (red_y), 0);
        hv_store (ice, "green_x", strlen ("green_x"),
                   newSVnv (green_x), 0);
        hv_store (ice, "green_y", strlen ("green_y"),
                   newSVnv (green_y), 0);
        hv_store (ice, "blue_x", strlen ("blue_x"),
                   newSVnv (blue_x), 0);
        hv_store (ice, "blue_y", strlen ("blue_y"),
                   newSVnv (blue_y), 0);
        return newRV_inc ((SV *) ice);
    }
    UNDEF;
